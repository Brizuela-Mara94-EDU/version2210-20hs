...
window.startScanner = async () => {
  ...
  try {
    ...
    const modelMapping = {
      ...
      oro: { path: 'oro.glb', scale: 0.5, rotation: { x: 0, y: 0, z: 0 } },
      wolframita: { path: 'wolframita.glb', scale: 0.5, rotation: { x: 0, y: 0, z: 0 } },
      renderamarillo: { path: 'renderamarillo.glb', scale: 1.5, rotation: { x: 0, y: 0, z: 0 } }
    };
